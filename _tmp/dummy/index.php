...
<div id="divWorkarea">
    <div id="divLoginbypersonal" class=" divLogin ">
        <div style=" background-color: #F1F1F1; padding: 8px 0px 8px 0px; border-radius: 5px; color:#F9A11B; text-shadow: 0px 1px 0px #E58D07; font-size: 13pt; font-weight: normal; margin-bottom: 10px; text-align: center;">Captura de Scrap</div>
        ...
        <input style=" font-size: 9pt; background-color: #F9A11B; border: 1px #000000 solid; color:#000000; box-shadow: 0px 1px 0px #E58D07; border-radius: 11px; padding: 2px 20px 0px 20px; " id="btnLoginpersonal" type="button" value="ingresar" onclick="goToCapture();" />
    ...
    <div id="divLoginbycredentials" class=" divLogin " style="display: none">
        <div style=" background-color: #F1F1F1; padding: 8px 0px 8px 0px; border-radius: 5px; color:#F9A11B; text-shadow: 0px 1px 0px #E58D07; font-size: 13pt; font-weight: normal; margin-bottom: 10px; text-align: center;">Ingreso a Sistema</div>
        ...
        <br />
        <input style=" font-size: 9pt; background-color: #F9A11B; border: 1px #000000 solid; color:#000000; box-shadow: 0px 1px 0px #E58D07; border-radius: 11px; padding: 2px 20px 0px 20px; " id="btnLogincredentials" type="button" value="ingresar" />
        <div id="divSeparator" style="width: 300px;"></div>
        <div style="text-align: right;">
