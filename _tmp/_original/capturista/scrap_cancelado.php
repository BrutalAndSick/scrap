...
function validar(destino) {
	if(destino=='excel') { 
		form1.action='excel_reportes.php?op=consulta&tipo=cancelado';
		form1.submit();	
  ...
  <tr>
    <td><?php submenu('b_consulta','cancelados'); ?></td>
...
<tr>
	<td class="titulo" width="200">SCRAP CANCELADO</td>
	<td align="left">&nbsp;
...
function reporte($fechai,$fechaf,$buscar,$filtros) { 
	...
	$s_1.= "folios.financiero, folios.archivo, folios.info_1, folios.info_2 from scrap_partes as partes, scrap_folios as folios where folios.activo='2' ";
	$s_1.= "and folios.no_folio = partes.no_folio ";	
...
<table align="center" class="tabla">
	<tr height="20">
        ...
        <td><?php $s_1 = "select campo, nombre from encabezados where c_cancelados='1' order by nombre"; 
	              $r_1 = mysql_query($s_1); ?>
