...
function validar(tipo,tabla) {
	...
	if(form1.global_pc.value=='') {
		alert('Es necesario ingresar el Global P.C.');
		form1.global_pc.focus(); return; }		
...
function exportar() {
	form1.action = 'excel.php?op=modelos';
	form1.submit();
	form1.action = 'modelos.php';
}
...
<tr height="600" valign="top">
	...
	<?php menu_interno($type,$tabla);
		...
		case "guardar"			:	guardar($tabla,$tipo,$nombre,$costo,$unidad,$descripcion,$global_pc); 
									nuevo($type,$tabla); break;
	
		case "listado"			:	listado($type,$tabla,$orden,$tipo,$buscar,$inicio); break;
		...
		case "update"			:	update($id_,$nombre,$descripcion,$costo,$unidad,$orden,$tabla,$tipo,$buscar,$inicio,$global_pc); 
									listado($type,$tabla,$orden,$tipo,$buscar,$inicio); break;
...
<tr>
	...
	<td><img src="../imagenes/division_submenu.png"></td>
	<td><a href="?op=unidades&tabla=<?php echo $tabla;?>" class="menuLink">Unidades</a></td><?php } ?>    
</tr>
</table></div><hr>
<?php } 	
...
<br><div align="center">
	...
	<tr><td class="gris" align="left">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		6.- La sexta columna contiene el global profit center</td>	
	</tr>	
	<tr><td class="gris" align="left">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<br><div align="center">
	...
	<tr><td class="gris" align="left">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		7.- La séptima columna contiene el global profit center</td>	
	</tr>	
	<tr><td class="gris" align="left">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<tr>
	<td valign="top">Global P.C.:*</td>
	<td><input type="text" name="global_pc" class="texto" size="20">
	</td>
</tr>
<tr>
...
function guardar($tabla,$tipo,$nombre,$costo,$unidad,$descripcion,$global_pc) {
	$tabla = trim($tabla);
	$tipo  = trim($tipo);
	$nombre = trim($nombre);
	$costo = trim($costo);
	...
	if($existe=='NO') {
	 $s_1 = "insert into numeros_parte values('','$nombre','$descripcion','$tabla','$tipo','$costo','$unidad','$global_pc','1','NA')";
	 $r_1 = mysql_query($s_1);
		echo"<script>alert('Registro almacenado');</script>"; }
...
<thead>
	<tr bgcolor="#E6E6E6" height="20">
		...
		<td width="100" align="center">
 		...
 		<td width="100" align="center">
			<a href="?op=listado&orden=global_pc&tabla=<?php echo $tabla;?>&tipo=<?php echo $tipo;?>" class="linkTabla">Global P.C.</a></td>    
		<td width="40" align="center">Editar</td>
		<td width="40" align="center">Borrar</td>
	</tr>
</thead>
<?php 
   $s_1  = "select * from numeros_parte where tipo like '$tipo' and activo!='2' and tabla='$tabla' and nombre like '$buscar%' order by $orden asc limit $inicio,100"; $j=$inicio+1;
   $r_1  = mysql_query($s_1); 
...
<tr onMouseOut="this.style.background='#F7F7F7'" onMouseOver="this.style.background='#FFDD99'" bgcolor="#F7F7F7" height="20">
	...
	<td align="center">
		...
		<?php if($d_1['activo']=='1') { echo"<a href='?op=estado&id_=$d_1[id]&estado=0&nombre=$d_1[nombre]$ruta'>
		   ...
		   if($d_1['activo']=='0') { echo"<a href='?op=estado&&id_=$d_1[id]&estado=1&nombre=$d_1[nombre]$ruta'>
									      <img src='../imagenes/cross.png' alt='Inactivo' border='0'>"; } } else { 
	...
	<td align="center">
		...
		<img src="../imagenes/pencil.gif" alt="Editar" border="0"></a><?php } else { ?><img src="../imagenes/pencil_gris.gif" alt="No puede editar" /><?php } ?></td>
	<td align="center">
    	<?php if($_SESSION["TYPE"]=='administrador') { ?>
		<a href="?op=borrar&id_=<?php echo $d_1['id'];?><?php echo $ruta;?>" onclick='return confirm("¿Borrar Registro?")'>
		<img src="../imagenes/delete.gif" alt="Borrar" border="0"></a><?php } else { ?><img src="../imagenes/delete_gris.gif" alt="No puede borrar" /><?php } ?></td>
</tr>
<?php $j++; } ?>
</tbody>
</table>
...
<tr>
	<td valign="top">Global P.C.:*</td>
	<td><input type="text" name="global_pc" class="texto" size="20" value="<?php echo $d_1['global_pc'];?>">
	</td>
</tr>
<tr>
	<td valign="top">Descripción:</td>
...
function update($id_,$nombre,$descripcion,$costo,$unidad,$orden,$tabla,$tipo,$buscar,$inicio,$global_pc) {
	$des = htmlentities($descripcion,ENT_QUOTES,"UTF-8");
	$s_1 = "update numeros_parte set nombre='$nombre', costo='$costo', descripcion='$des', tipo='$tipo', unidad='$unidad', global_pc='$global_pc' where id='$id_'";
	$r_1 = mysql_query($s_1); 
}	
