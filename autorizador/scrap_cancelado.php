...
<tr>
	<td class="titulo" width="190">SCRAP CANCELADO</td>
	<td align="left">&nbsp;
...
function reporte($fechai,$fechaf,$buscar,$filtros) { 
	...
	$s_1.= "folios.financiero, folios.archivo, folios.info_1, folios.info_2 from scrap_partes as partes, scrap_folios as folios where folios.activo='2' and " ;
	$s_1.= "folios.no_folio = partes.no_folio ";	
...
<table align="center" class="tabla">
	<tr height="20">
        ...
        <td><?php $s_1 = "select campo, nombre from encabezados where a_cancelados='1' order by nombre"; 
	              $r_1 = mysql_query($s_1); ?>
...
<tbody>
<?php if($total>0) { 
	 $s_1 = "select * from vw_reportes_".$_SESSION["IDEMP"]." order by no_folio desc limit $ini_,$fin_";
	 $r_1 = mysql_query($s_1);
