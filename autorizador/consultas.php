...
<script>
function exportar() {
	form1.action='excel_reportes.php?op=consultas';
	form1.submit();	
	form1.action='consultas.php';
}
...
<tr>
	...
	<td align="left">&nbsp;
	<span title="header=[&nbsp;&nbsp;<?php echo $titulo;?>] body=[Usted puede revisar el estado de boleta de scrap en base a los colores y las banderas:<br><br>
...
<table align="center" class="tabla">
	<tr height="20">
        ...
        <td><?php $s_1 = "select campo, nombre from encabezados where a_proceso='1' order by nombre"; 
	              $r_1 = mysql_query($s_1); ?>
	...
	<tr height="20">
		...
		<td align="center">
        <input type="radio" value="si" name="aplica_oes" <?php if($aplica_oes=='si') { ?>checked="checked"<?php } ?> onclick='filtro_oes();'>&nbsp;&nbsp;SI</td>	
	</tr>    
	<tr height="20">
		<td align="left" width="62">&nbsp;&nbsp;Buscar:</td>
   		<td>
		...
		<td align="center">
        <input type="radio" value="no" name="aplica_oes" <?php if($aplica_oes=='no') { ?>checked="checked"<?php } ?> onclick='filtro_oes();'>&nbsp;&nbsp;NO</td>
	</tr>         
</table>
...
<?php 
	...
	$s_f.= filtros_autorizador(); $s_f.= " group by folios.no_folio order by folios.no_folio ASC) as general ";
...
<tr>
    ...
    <td width="30" align="center" bgcolor="<?php echo $color;?>">
    	<a href="consultas.php?tipo=<?php echo $tipo;?><?php echo $ruta;?>&pagina=<?php echo $i;?>" class="link_paginas"><?php echo $i;?></a></td>
	<?php $i++; $j++; } ?>
    </table>
    </td>
</tr>    
...
<tr bgcolor="#E6E6E6" height="20">
    ...
    <?php if($_SESSION["DEPTO"]=='lo' || $_SESSION["DEPTO"]=='loa') { $cols = 5; ?>
    <td align="center" width="25"><img src="../imagenes/attach.png" /></td><?php } else { $cols = 4; } ?>    
	...
	<?php  if($_SESSION["DEPTO"]=='lo') { $class = 'naranja'; } else { $class = ''; }
		...
		if($_SESSION["DEPTO"]=='fin') { $class = 'naranja'; } else { $class = ''; }
			echo"<td width='60' align='center'><span class=$class>Finanzas</span></td>"; 
		if($_SESSION["DEPTO"]=='esp') { $class = 'naranja'; } else { $class = ''; }
			echo"<td width='60' align='center'><span class=$class>ESP</span></td>"; 
		if($_SESSION["DEPTO"]=='oes') { $class = 'naranja'; } else { $class = ''; }
