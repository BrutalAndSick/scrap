...
function cancelar(ruta) {
  ...
  <tr>
    <td><?php submenu('b_plantas','motivos_sap'); ?></td>
...
<tr>
	<td class="titulo" width="150">MOTIVOS SAP</td>
...
<caption>Nuevo Motivo SAP</caption>
<tr>
	<td>Motivo:</td>
...
function ver_si_existe($motivo) {
	$s_1 = "select * from motivos_sap where motivo='$motivo' and activo!='2'";
	$r_1 = mysql_query($s_1);
...
function listado($orden,$pagina) {
   ...
   <?php
	$s_1 = "select * from motivos_sap where activo!='2' order by motivo DESC, $orden ASC";
    $r_1 = mysql_query($s_1); 
...
function editar($id_) { 
	$s_1 = "Select * from motivos_sap where id='$id_'";
	$r_1 = mysql_query($s_1); 
...
<table align="center" class="tabla" cellpadding="0" cellspacing="5">
<caption>Editar Motivo SAP</caption>
<tr>
	<td>Motivo:</td>
...
function update($id_,$motivo) {
	$motivo = trim($motivo);
	$s_1 = "update motivos_sap set motivo='$motivo' where id='$id_'"; 
	$r_1 = mysql_query($s_1); 
}	


function borrar($id_,$nombre) {
	$s_1 = "delete from motivos_sap where id='$id_'";
	$r_1 = mysql_query($s_1); 
}	


function estado($id_,$estado,$nombre) {
	$s_1 = "update motivos_sap set activo='$estado' where id='$id_'";
	$r_1 = mysql_query($s_1); }
?>