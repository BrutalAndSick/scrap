...
class adLDAP {
    ...
    * @var string
    */   
	protected $_account_suffix = "@cw01.contiwan.com";
    							 //@gruporisc.local
    /**
    ...
    * @var string
    */
	protected $_base_dn = "DC=cw01,DC=contiwan,DC=com"; 
						   //DC=gruporisc,DC=local
    ...
    * @var array
    */
    protected $_domain_controllers = array ("dc01.cw01.contiwan.com");
									 //dc01.gruporisc.local
