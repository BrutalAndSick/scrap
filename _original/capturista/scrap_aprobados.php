...
<tr>
	<td class="titulo" width="200">SCRAP APROBADO</td>
	<td align="left">&nbsp;
...
if($reportar==1) { 
	...
	$s_1.= "folios.financiero, folios.archivo from scrap_partes as partes, scrap_folios as folios, folios.info_1, folios.info_2 where folios.activo='1' and ";
	...
	$s_1.= filtros_capturista($division); $s_1.= " group by folios.no_folio order by no_folio DESC"; 
...
<div align="center" class="aviso">Los encabezados de la tabla permiten ordenar los campos. Haga clic en las banderas para ver detalles de autorización. Para ver los folios aprobados utilice al menos un filtro o rango de fechas.</div>	
...
<table align="center" class="tabla">
	<tr height="20">
        ...
        <td><?php $s_1 = "select campo, nombre from encabezados where c_aprobados='1' order by nombre"; 
	              $r_1 = mysql_query($s_1); ?>
...
<tr onMouseOut="this.style.background='#F7F7F7'" onMouseOver="this.style.background='#FFDD99'" bgcolor="#F7F7F7" height="20">
	<td align="center">
		<?php if($_SESSION["IDEMP"]==$d_1['id_emp']) { ?>
