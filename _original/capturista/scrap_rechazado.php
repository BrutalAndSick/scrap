...
<tr>
	<td class="titulo" width="200">SCRAP RECHAZADO</td>
	<td align="left">&nbsp;
...
<div align="center" class="aviso">Utilice los filtros para generar búsquedas. Al cambiar un filtro, haga clic en el botón Buscar para refrescar la información. El reporte muestra toda la información sobre folios rechazados.</div>
...
<table align="center" class="tabla">
	<tr height="20">
        ...
        <td><?php $s_1 = "select campo, nombre from encabezados where c_rechazados='1' order by nombre"; 
	              $r_1 = mysql_query($s_1); ?>
