...
_.sValue = oSettings['valor'];
_.sTitulo = oSettings['titulo'];
...
_.sChiefFormat = !oSettings.dateFormat ? 'Y-m-d' : oSettings.dateFormat;
_.oApp = oSettings['appearance'];
gBuildControl(_);
}
function gBuildControl(_) {
var oWbuf = new writer();
oWbuf.into  ('<table cellpadding="0" cellspacing="0" border="0" ><tr><td>' , _.sTitulo , '<input type="Text" id="' , _.sNameControl , '"  name="' , _.sNameControl , '" value="', _.sValue ,'"  class ="texto" size="8" tabindex="2"></td><td align="right" width="25"><a href="javascript:gDisplayCalendar(agC[' + _.nCId + ']);"><img src="',_.oApp['IcoCalVis'],'" alt="" name="'+ _.sIcoName +'" id="'+ _.sIcoName +'" width="23" height="19" border="0"></a></td></tr><tr><td align="left" colspan="2"><img src="img/spacer.gif" alt="" name="'+ _.sPosName +'" id="'+ _.sPosName +'" width="1" height="1" border="0"></td></tr></table>');
