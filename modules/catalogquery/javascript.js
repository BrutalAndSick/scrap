...
function loadQueryFilters($intTableId){
...
function importExcel(){
    console.clear();
    $strQueryString = "intTableId=" + $jsnGridData.intTableId + "&strProcess=importExcel&strTempFile=" + encodeURIComponent($('#btnImportSubmit').attr('tempfile'));
