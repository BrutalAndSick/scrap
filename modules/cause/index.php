    ...
    <body>
        ...
        <div class="divGrid" id="divGrid">
            <table class="tblGrid">
                ...
                array_push($arrHeaders,array('strLabel'=>'Causa','strSortColumn'=>'ARE_NAME'));
        ...
        <div id="divModalBackground">
            <div id="divModalMain" style="width: 300px;">
                ...
                <div id="divModalForm">
                    <table>
                        <tr>
                            <td><label for="txtName" class="form_label" style="width: 88px;">Causa</label></td>
                ...
                <div id="divModalButtons">
                    <input id="btnModalAdd" type="button" value="insertar" onclick="addCause();" class="buttons button_green">
                    <input id="btnModalEdit" type="button" value="editar" onclick="updateCause();" class="buttons button_green">
