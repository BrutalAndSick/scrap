    ...
    <body>
        ...
        <div class="divGrid" id="divGrid">
            <table class="tblGrid">
                ...
                $objGrid = new clsGrid();
                $arrHeaders = array();
                array_push($arrHeaders,array('strLabel'=>'Id','strSortColumn'=>'PRT_ID'));
                array_push($arrHeaders,array('strLabel'=>'Centro de Costos','strSortColumn'=>'PRT_NAME'));
                array_push($arrHeaders,array('strLabel'=>'Estatus','strSortColumn'=>'PRT_STATUS'));
        ...
        <div id="divModalBackground">
            <div id="divModalMain" style="width: 300px;">
                ...
                <div id="divModalForm">
                    ...
                    <label for="tblSegment" class="form_label">Segmento</label>
                    <table id="tblSegment"></table>
                </div>
                <!-- ##### FORMULARIO A APLICAR ##### -->
                <div id="divModalError"></div>
                <div id="divModalButtons">
                    <input id="btnModalAdd" type="button" value="insertar" onclick="addProfitCenter();" class="buttons button_green">
                    <input id="btnModalEdit" type="button" value="editar" onclick="editProfitCenter();" class="buttons button_green">
