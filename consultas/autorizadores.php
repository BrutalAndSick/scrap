...
function validar(destino) {
	if(destino=='excel') { 
		form1.action='excel_reportes.php?reporte=autorizador';
		form1.submit();	
...
<tr bgcolor="#E6E6E6" height="20">
    ...
    <?php if($_SESSION["DEPTO"]=='lo' || $_SESSION["DEPTO"]=='loa') { $cols = 6; ?>
    <td align="center" width="25"><img src="../imagenes/attach.png" /></td><?php } else { $cols = 5; } ?>    
